...
|----------|-----------------|
| ![ResNet50 before](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\ResNet50_calibration.png) | ![EfficientNet before](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\EfficientNet-B0_calibration.png) |
| Before calibration (ECE=0.120) | Before calibration (ECE=0.100) |
| ![ResNet50 temp](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\ResNet50_temp.png) | ![EfficientNet temp](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\EfficientNet-B0_temp.png) |
...
| ResNet50 | EfficientNet-B0 |
|----------|-----------------|
| ![ResNet50 dirichlet](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\ResNet50_dirichlet.png) | ![EfficientNet dirichlet](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\EfficientNet-B0_dirichlet.png) |
...
| Sample | Image | Notes |
|--------|-------|-------|
| 000 — 55.73% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_000_✓_pred_normal_true_normal.png) | Multi-cell frame. Activation on primary head, spreads slightly — lower confidence from scene complexity, not wrong attention |
| 001 — 56.62% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_001_✓_pred_normal_true_normal.png) | Borderline head morphology. Heatmap is tight on nucleus — uncertainty is morphologically justified |
| 002 — 87.44% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_002_✓_pred_normal_true_normal.png) | Single sperm with tail. Clean head activation, tail completely ignored |
| 003 — 89.56% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_003_✓_pred_normal_true_normal.png) | Elongated sperm. Activation tracks head-midpiece junction precisely |
| 004 — 72.99% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_004_✓_pred_normal_true_normal.png) | Dual-head artifact in view. Model spreads activation across both heads, confidence drops accordingly |
...
|--------|-------|--------|-------|
| 012 — 59.45% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_012_✓_pred_normal_true_normal.png) | ✅ Correct | Sperm near slide edge — a difficult frame with the dark slide border visible. Model ignores the edge entirely and focuses on the head. Low confidence is appropriate given the partial occlusion |
| 013 — 82.82% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_013_✓_pred_normal_true_normal.png) | ✅ Correct | Clean elongated sperm, clear head. Compact, well-placed activation. One of the cleaner examples in the set |
| 014 — 76.53% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_014_✓_pred_normal_true_normal.png) | ✅ Correct | Multi-cell frame with debris in background. Model focuses tightly on the correct elongated sperm head in centre-right, ignoring the smaller debris cell on the left |
| **015 — 50.72%** | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_015_✗_pred_non_sperm_true_normal.png) | ❌ **Misclassified** | **True: normal — Pred: non_sperm.** The model sees a large pear-shaped head with an unusually elongated midpiece attachment, and at 50.72% confidence it barely tips over the non_sperm threshold. The Grad-CAM activation covers the full head-neck region rather than just the nucleus, which is consistent with the model being genuinely confused about what structure it is looking at. This is the most borderline morphology in the set |
| 016 — 77.57% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_016_✓_pred_normal_true_normal.png) | ✅ Correct | Single sperm with tail fully in frame. Activation precisely on head, tail ignored |
| 017 — 64.56% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_017_✓_pred_normal_true_normal.png) | ✅ Correct | Abnormal-looking tail attachment — head activation is correct but confidence is lower, which makes sense given the unusual midpiece morphology |
| 018 — 74.51% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\efficientnet_b0\20260304_205814\sample_018_✓_pred_normal_true_normal.png) | ✅ Correct | **Hardest correct prediction in the set.** Very cluttered background with debris and overlapping cellular material everywhere. Despite this, the model locks onto the sperm head in centre-frame. This is a strong result — the preprocessing pipeline (CLAHE + background subtraction) is almost certainly doing useful work here |
...
| Sample | Image | Notes |
|--------|-------|-------|
| 000 — 84.08% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\resnet50\20260304_205237\sample_000_✓_pred_normal_true_normal.png) | Same multi-cell frame — commits to one head, 28 pp more confident than EfficientNet |
| 001 — 91.04% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\resnet50\20260304_205237\sample_001_✓_pred_normal_true_normal.png) | Highest confidence in set. Tight circular activation on acrosomal region |
| 002 — 88.53% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\resnet50\20260304_205237\sample_002_✓_pred_normal_true_normal.png) | Head+midpiece activation. Both models agree on this frame |
| 003 — 86.93% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\resnet50\20260304_205237\sample_003_✓_pred_normal_true_normal.png) | Elongated sperm. Head activation, no tail bleed |
| 004 — 89.14% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\resnet50\20260304_205237\sample_004_✓_pred_normal_true_normal.png) | Dual-head frame — focuses on larger head, 16 pp more confident than EfficientNet |
...
| Sample | Image | Result | Notes |
|--------|-------|--------|-------|
| 015 — 62.94% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\resnet50\20260304_205237\sample_015_✓_pred_normal_true_normal.png) | ✅ Correct | Same pear-shaped sperm that EfficientNet misclassified as non_sperm at 50.72%. ResNet50 gets it right here, but at only 62.94% — both models are uncertain, they just fail on different edge cases |
| 016 — 88.20% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\resnet50\20260304_205237\sample_016_✓_pred_normal_true_normal.png) | ✅ Correct | Single elongated sperm with tail. Clean head-midpiece activation, confident and correct |
| 017 — 84.49% | ![](C:\Users\admin\Desktop\sperm-morphology-cnn\experiments\results\gradcam\resnet50\20260304_205237\sample_017_✓_pred_normal_true_normal.png) | ✅ Correct | Unusual tail attachment at head-midpiece junction. Correct head focus, both models handle this well |
